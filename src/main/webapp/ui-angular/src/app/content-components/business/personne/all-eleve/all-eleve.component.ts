...
@Component({
  selector: 'app-all-eleve',
  templateUrl: './all-eleve.component.html',
  styleUrls: ['./all-eleve.component.css']
})
export class AllEleveComponent implements OnInit {
  displayedColumns: string[] = ['id', 'matricule', 'nom', 'naissance', 'sexe', 'telephone', 'actions'];
  elevelist = null;
